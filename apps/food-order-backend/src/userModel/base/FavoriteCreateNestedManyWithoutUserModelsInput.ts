...
@InputType()
class FavoriteCreateNestedManyWithoutUserModelsInput {
...
export { FavoriteCreateNestedManyWithoutUserModelsInput as FavoriteCreateNestedManyWithoutUserModelsInput };
