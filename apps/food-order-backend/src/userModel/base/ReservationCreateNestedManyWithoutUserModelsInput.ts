...
@InputType()
class ReservationCreateNestedManyWithoutUserModelsInput {
...
export { ReservationCreateNestedManyWithoutUserModelsInput as ReservationCreateNestedManyWithoutUserModelsInput };
