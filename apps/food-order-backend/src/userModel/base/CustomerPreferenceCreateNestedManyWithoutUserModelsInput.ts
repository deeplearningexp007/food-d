...
@InputType()
class CustomerPreferenceCreateNestedManyWithoutUserModelsInput {
...
export { CustomerPreferenceCreateNestedManyWithoutUserModelsInput as CustomerPreferenceCreateNestedManyWithoutUserModelsInput };
