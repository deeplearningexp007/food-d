...
@InputType()
class NotificationSettingCreateNestedManyWithoutUserModelsInput {
...
export { NotificationSettingCreateNestedManyWithoutUserModelsInput as NotificationSettingCreateNestedManyWithoutUserModelsInput };
