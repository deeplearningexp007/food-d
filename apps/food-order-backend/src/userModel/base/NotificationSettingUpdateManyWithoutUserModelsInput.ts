...
@InputType()
class NotificationSettingUpdateManyWithoutUserModelsInput {
...
export { NotificationSettingUpdateManyWithoutUserModelsInput as NotificationSettingUpdateManyWithoutUserModelsInput };
