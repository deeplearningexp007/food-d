...
@InputType()
class FavoriteRestaurantCreateNestedManyWithoutRestaurantsInput {
...
export { FavoriteRestaurantCreateNestedManyWithoutRestaurantsInput as FavoriteRestaurantCreateNestedManyWithoutRestaurantsInput };
