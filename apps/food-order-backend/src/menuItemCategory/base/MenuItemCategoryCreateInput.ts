...
@InputType()
class MenuItemCategoryCreateInput {
  @ApiProperty({
    required: false,
  ...
  @ApiProperty({
    required: false,
    type: () => MenuItemCreateNestedManyWithoutMenuItemCategoriesInput,
  })
  @ValidateNested()
  @Type(() => MenuItemCreateNestedManyWithoutMenuItemCategoriesInput)
  @IsOptional()
  @Field(() => MenuItemCreateNestedManyWithoutMenuItemCategoriesInput, {
    nullable: true,
  })
...
export { MenuItemCategoryCreateInput as MenuItemCategoryCreateInput };
