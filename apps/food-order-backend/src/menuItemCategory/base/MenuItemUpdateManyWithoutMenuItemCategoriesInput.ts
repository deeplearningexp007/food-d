...
@InputType()
class MenuItemUpdateManyWithoutMenuItemCategoriesInput {
...
export { MenuItemUpdateManyWithoutMenuItemCategoriesInput as MenuItemUpdateManyWithoutMenuItemCategoriesInput };
